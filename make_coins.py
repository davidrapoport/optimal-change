...
def make_change_helper(cent, optimal_change_for_cent, coins):
	...
	if best_coin == -1:
		print ("Best coin is -1 for cent: {}\noptimal_cache: {}\ncoins: {}"
			.format(cent, optimal_change_for_cent, coins))
		return
...
## Input:
##	optimal_change_dict: The output of make_change that you are interested in determining
##		whether or not it's greedy. It maps cents (0-99) -> the optimal set of coins to make 
##		cents amount of change.
##	coins:
##		A list of the coins used to generate optimal_change_dict
## Output:
##	True if every result in optimal_change_dict is the same as what is generated by a greedy
